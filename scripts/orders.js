...
const productQuantityElement = button.closest('.product-details').querySelector('.js-product-quantity');

let currentQuantity = parseInt(productQuantityElement.innerHTML.match(/\d+/)[0]);
currentQuantity += 1;
productQuantityElement.innerHTML = `Quantity: ${currentQuantity}`;
